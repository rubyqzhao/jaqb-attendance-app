...
public class CheckAttendance extends AppCompatActivity {
    ...
    private String date;
    private List<String> studentsAttendance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentsAttendance = new ArrayList<>();
        listView = (ListView) findViewById(R.id.dates_course_list);
        findViewById(R.id.dates_progressBar).setVisibility(View.GONE);
        arrayAdapter = new ArrayAdapter<>(this, R.layout.class_list_item, R.id.class_item, studentsAttendance);
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot keyNode : dataSnapshot.getChildren()){
                    ...
                    studentsAttendance.add(studentId + " : " + ((attendance)?"Present" : "Absent"));
                }
